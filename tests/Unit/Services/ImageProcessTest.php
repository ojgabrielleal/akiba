...
class ImageProcessTest extends TestCase
{
    ...
    public function test_it_deletes_existing_image_from_public_disk(): void
    {
        ...
        $deleted = (new ImageProcess)->delete('/storage/images/avatars/delete-me.webp');
    ...
    public function test_it_returns_false_when_deleting_missing_image(): void
    {
        ...
        $deleted = (new ImageProcess)->delete('/storage/images/avatars/missing.webp');
