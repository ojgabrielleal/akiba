                                ...
                                <nav class="flex flex-wrap gap-2" aria-label="Reviews">
                                    {#each reviews as item}
                                        <button
                                            type="button"
                                            class={[
                                                "cursor-pointer rounded-md px-4 py-2 font-noto-sans text-sm font-black uppercase italic transition duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-citric",
