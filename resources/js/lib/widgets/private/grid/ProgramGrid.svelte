<script>
    ...
    import { EmptyState, GridList, IconButton, Offcanvas, Section } from "@/lib/components/private/";
    import { ProgramForm } from "@/lib/widgets/private";
    import { programPermissions, resolveDateTime, resolveDay, resolveHour, resolvePlaceholderImage } from "@/lib/utils";

    export let title;
    export let programs = null;
    export let users = null;

    const can = programPermissions();
    ...
    function requestDeactivateProgram(program) {
...
<Offcanvas bind:this={offcanvasRef} title={offcanvasTitle}>
    <div slot="content" let:close>
        <ProgramForm {programSelected} {users} {close} />
    </div>
</Offcanvas>
