<script>
    ...
    import { CalendarForm } from "@/lib/widgets/private";
    import { calendarPermissions, resolveHour } from "@/lib/utils";
    import { calendarTags } from "@/lib/constants";
...
<Offcanvas bind:this={offcanvasRef} title={offcanvasTitle}>
    <div slot="content" let:close>
        <CalendarForm {eventSelected} {users} {close} />
    </div>
</Offcanvas>
