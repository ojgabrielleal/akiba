<script>
    ...
    import { Badge, EmptyState, GridList, IconButton, Offcanvas, Section } from "@/lib/components/private";
    import { UserForm, UserAccessForm } from "@/lib/widgets/private";
    import { resolvePlaceholderImage, userGridPermissions } from "@/lib/utils";
