<script>
    ...
    import { Carousel, EmptyState, IconButton, Offcanvas, Section, Tooltip } from "@/lib/components/private/";
    import { ActivityForm } from "@/lib/widgets/private";
    import { activityPermissions, resolvePlaceholderImage } from "@/lib/utils";
    ...
    function requestConfirmActivityParticipant(activity) {
